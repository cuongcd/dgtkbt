...
//    }
    ...
    public function formatDatetime($datetime){
        $format = $this->getFormat()?:'Y-m-d H:i:s';
        return ($this->isTimeZone())?DateTime::formatDatetime($format, $datetime):DateTime::formatGmtDatetime($format, $datetime);
    }
}