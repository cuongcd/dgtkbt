...
class Grid extends BaseGrid
{
    ...
    {
        $this->setTitle('Quản Lý Loại Xếp Loại');
        $this->setGridUrl(URL::to('points/index'));
        $this->setAjaxGridUrl(URL::route('points.grid'));
    ...
    protected function _addGridButtons()
    {
        $this->_addGridButton('download', [
            'url' => URL::route('points.export', ['xlsx']),
    ...
    * */
    protected function _addMassactions()
    {
        $this
            ->_addMassaction('delete', [
                ...
                'url' => URL::route('points.mass-delete'),
    ...
    {
        return URL::route('points.edit', $row->_id);
    }
