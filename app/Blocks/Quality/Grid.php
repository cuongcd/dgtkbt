...
class Grid extends BaseGrid
{
    ...
    {
        $this->setTitle("");
        $this->setGridUrl(URL::to('qualities/index'));
        $this->setAjaxGridUrl(URL::route('qualities.grid'));
    ...
    protected function _addButtons()
    {
        parent::_addButtons();
        $this->_addButton('add', [
            'url' => URL::route('qualities.create'),
...
//                'edit' =>true,
    ...
    {
        return URL::route('qualities.edit', $row->_id);
    }
}