...
<head>
    ...
    {{--{!! HTML::style('css/inventory/jAlert-v4.css')!!}--}}
    {{--{!! HTML::script('js/inventory/jquery-1.11.3.min.js') !!}--}}
    {{--{!! HTML::script('js/inventory/jAlert-v4.js') !!}--}}
    {{--{!! HTML::script('js/inventory/jAlert-functions.js') !!}--}}
