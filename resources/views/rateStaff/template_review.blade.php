<div id="product_review">
    <label class="control-label">Đánh Giá Nhân Viên</label>
    ...
    <div class="ibox float-e-margins" id="productReviews">
            ...
            <div class="modal-dialog modal-lg tax">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-lg-9">
                            <span id="edit_name_chuyenmon"></span>
                        </div>
                    </div>
                    <div class="modal-body">
        ...
        <div>
            ...
            <div class="btn btn-sm btn-primary right" style="margin-left: 10px"
                ...
                <i class="fa fa-plus"></i>
                <span class="bold" data-toggle="modal" data-target="#add_new_tiendo">Thêm Tiến Độ</span>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('change', 'table tbody [name="cv_phongdanhgia"]', function () {
        ...
        $(document).on('change', 'table tbody [name="cv_bandanhgia"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
            var KL = $(this).val();
            if (isdanhgia) {
                alert('Bạn Không Có Quyền Đánh Giá, Đánh Giá Đã Được Duyệt!!!');
        ...
        $(document).on('click', 'table tbody [name="editCongViec"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
        ...
        /*
         Tiến Độ Công Việc
         */
        $(document).on('change', 'table tbody [name="td_phongtru"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
        ...
        $(document).on('change', 'table tbody [name="td_bantru"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
            var ghichu = $(this).closest("tr").find('td:eq(6)').text().trim();
            var diemtru = $(this).val();
            if (isdanhgia) {
        ...
        /*Chat Luong COng Viecj

         */
        $(document).on('change', 'table tbody [name="cl_phongtru"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
            var ghichu = $(this).closest("tr").find('td:eq(6)').text().trim();
            var diemtru = $(this).val();
            if (isdanhgia) {
        ...
        $(document).on('change', 'table tbody [name="cl_bantru"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
            var ghichu = $(this).closest("tr").find('td:eq(6)').text().trim();
            var diemtru = $(this).val();
            if (isdanhgia) {
        ...
        /*
         Ky Luat
         */
        $(document).on('change', 'table tbody [name="kl_phongtru"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
            var ghichu = $(this).closest("tr").find('td:eq(6)').text().trim();
            var diemtru = $(this).val();
            if (isdanhgia) {
        ...
        $(document).on('change', 'table tbody [name="kl_bantru"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
            var ghichu = $(this).closest("tr").find('td:eq(6)').text().trim();
            var diemtru = $(this).val();
            if (isdanhgia) {
        ...
        $(document).on('change', 'table tbody [name="pc_phongtru"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
            var ghichu = $(this).closest("tr").find('td:eq(6)').text().trim();
            var diemtru = $(this).val();
            if (isdanhgia) {
        ...
        $(document).on('change', 'table tbody [name="pc_bantru"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
            var ghichu = $(this).closest("tr").find('td:eq(6)').text().trim();
            var diemtru = $(this).val();
            if (isdanhgia) {
        ...
        $(document).on('change', 'table tbody [name="dg_phongcong"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
            var ghichu = $(this).closest("tr").find('td:eq(6)').text().trim();
            var diemtru = $(this).val();
            if (isdanhgia) {
        ...
        $(document).on('change', 'table tbody [name="dg_bancong"]', function () {
            var _id = parseInt($(this).closest("tr").find('td:eq(0)').text());
            var ghichu = $(this).closest("tr").find('td:eq(6)').text().trim();
            var diemtru = $(this).val();
            if (isdanhgia) {
